...
if __name__ == "__main__":
    ...
    # meu_veiculo.set_num_registro(49024)
    ...
    # seu_carro = Carro("Ford", "Ford Ka")
    # seu_carro.movimentar()
    # seu_carro.get_fabr_modelo()
    # seu_carro.set_num_registro(34823)
    # print(f"Registro: {seu_carro.get_num_registro()}")

    # moto = Motocicleta("Kawasaki", "Ninja")
    # moto.movimentar()
